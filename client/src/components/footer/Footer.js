    ...
    <footer className="desktop-footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <ul>
            <li>
              <a href="" className="subfot">Instagram</a>
            </li>
            <li>
              <a href="" className="subfot">LinkedIn</a>
            </li>
            <li>
              <a href="" className="subfot">YouTube</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="footer-info">
        <p>
          &copy; 2022-2026 @ Made By <a href="#" target="_blank">Shirish</a>
        </p>
        <p>
          For any issue kindly send mail to <a type="mail" href="mailto:@gmail.com">@gmail.com </a>
        </p>
      </div>
    </footer>
  );
